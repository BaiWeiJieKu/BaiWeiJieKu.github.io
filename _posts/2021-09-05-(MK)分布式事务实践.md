...
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163084616206524_Copy_24.png)

- JmsTransactionManager事务

- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163084620640225_Copy_25.png)
...
- 本地事务
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163084788223328_Copy_28.png)
- 外部全局事务
  - 外部事务管理器提供事务管理
  ...
  - JTA事务管理器可以管理多个数据资源
  - 通过2阶段提交实现多数据源事务
- ![image-20210907221517324](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/image-20210907221517324.png)
- JTA事务管理的弊端
  - 两阶段提交
  - 事务实践太长，锁数据的实践太长
  - 低性能，低吞吐量
...
- JTA实现多服务的分布式事务
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16311060470851_Copy_1.png)
- 不使用JTA，消息驱动的分布式事务
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16311063516922_Copy_2.png)
- 如何选择
...
![image-20210908222708151](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/image-20210908222708151.png)
...
- 消息驱动模型
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16311940006211_Copy_1.png)
- 注意
  - 消息中间件需要支持事务
  - 如果处理重试的消息
  - 发生业务异常时回滚操作
...
- 错误处理：定时任务检查超时并回滚
- 幂等性：实现方法的幂等性
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16311943608125_Copy_5.png)
- 流程
- ![image-20210909225053250](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/image-20210909225053250.png)
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163119462783710_Copy_10.png)
- 失败场景
- ![image-20210909225307575](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/image-20210909225307575.png)
- 异常订单处理
...
- 实例
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16344657727927_Copy_7.png)
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/16344657890848_Copy_8.png)
- 事件溯源和CQRS
  - CQRS：命令查询职责分离
...
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163446641551713_Copy_13.png)
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163447642055514_Copy_14.png)
- axon处理command过程
...
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163447658985416_Copy_16.png)
- axon处理event过程
...
- ![img](https://baiweijieku-1253737556.cos.ap-beijing.myqcloud.com/images/163447670910618_Copy_18.png)
- 使用axon框架的设计过程
  - 领域模型设计
