...
- 日志：
- ![image.png](https://i.loli.net/2021/01/13/pAx8a2XseKVP1Oc.png)
...
- 测试结果
- ![image.png](https://i.loli.net/2021/01/13/WoyNR9TQZU2c74a.png)
...
- 排查死锁：
  ![image.png](https://i.loli.net/2021/01/20/IKaysGgUYzlQqhE.png)
...
![image.png](https://i.loli.net/2021/01/22/vuF2qUocVEZ7jyJ.png)
...
- ![image.png](https://i.loli.net/2021/01/26/75LcgPn9XOKU24l.png)
...
- ![image.png](https://i.loli.net/2021/01/26/tclVxIG9LETZh62.png)
- B+ 树的特点包括：
  - 最底层的节点叫作叶子节点，用来存放数据
...
- ![image.png](https://i.loli.net/2021/01/26/SPGF5j3nlYkhrpw.png)
...
- 把 SQL 中的 * 修改为 NAME 和 SCORE，也就是 SELECT name_score 联合索引包含的两列:
  ...
  - ![image.png](https://i.loli.net/2021/01/26/bctJlmZdg4TH3ij.png)
...
- ![image.png](https://i.loli.net/2021/02/19/fh3gtsQbDOAXEqn.png)
...
- ![image.png](https://i.loli.net/2021/03/04/BIcu4NJjSXkKWYZ.png)
- SLF4J 实现了三种功能：
...
- ![image.png](https://i.loli.net/2021/03/11/j2kXgQOiovNxPmG.png)
