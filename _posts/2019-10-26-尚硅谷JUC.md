...
- ![img](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/85616C9C-BA7A-470A-9D29-E8114E07FD57.png)
...
- ![img](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/29B52783-1875-4BCC-B075-4280D8159E97.png)
- AQS为什么是JUC中最重要的基石
- ![img](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/480394AD-0100-4564-BD9D-F89BA1CFE183.png)
...
- ![img](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/9A6F1674-AA93-42E0-91A4-24B29DD6CB77.png)

- ![img](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/2CBA82A9-06C1-4B30-ADAB-77FA06B17C30.png)

- ![image-20210808222858831](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210808222858831.png)

- CLH队列：通过自旋等待，state变量判断是否阻塞，从尾部入队，从头部出队。

- ![image-20210809220324884](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809220324884.png)
...
- ![image-20210809221344822](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809221344822.png)

- AQS同步队列的基本结构

- ![image-20210809221750171](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809221750171.png)
...
- ![image-20210809230604747](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809230604747.png)

- Lock接口的实现类，基本都是通过【聚合】了一个【队列同步器】的子类完成线程访问控制的

- ReentrantLock原理

- ![image-20210809222618526](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809222618526.png)

- 从最简单的lock方法开始看看公平和非公平

- ![image-20210809222840064](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809222840064.png)

- ![image-20210809223005637](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809223005637.png)
...
- ![image-20210809223327288](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809223327288.png)
- lock()
- ![image-20210809223442966](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809223442966.png)
- acquire()三大流程走向
- 占位
- tryAcquire(arg)
- ![image-20210809225305319](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809225305319.png)
- nonfairTryAcquire(acquires)：return false继续推进条件，走下一个方法addWaiter；return true结束
- ![image-20210809225340333](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809225340333.png)
- addWaiter(Node.EXCLUSIVE)
- ![image-20210809225655934](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809225655934.png)
- enq(node);双向链表中，第一个节点为虚节点(也叫哨兵节点)，其实并不存储任何信息，只是占位。 真正的第一个有数据的节点，是从第二个节点开始的。
- ![image-20210809225737001](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809225737001.png)
- 假如3号ThreadC线程进来
  prev
  compareAndSetTail
  next
- acquireQueued(addWaiter(Node.EXCLUSIVE), arg)
- ![image-20210809225854591](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809225854591.png)
- 假如再抢抢失败就会进入
...
- ![image-20210809230235811](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809230235811.png)
...
- tryRelease(arg)
- unparkSuccessor
- ![image-20210809230405961](https://gitee.com/shanyuanjushi/picgo_images/raw/master/images/image-20210809230405961.png)
